...
class apnliveSpider(BaseSpider):
    ...
    def parse_news_list(self, response):
        ...
        if page_number and response.meta["page"] < int(page_number[-1]):
            ...
            if OldDateUtil.time == None or OldDateUtil.format_time3(time2) >= int(OldDateUtil.time):
    ...
    def parse_news(self, response):
        ...
        item["pub_time"] = time_list[0] + " " + time_list[1] if time_list else OldDateUtil.format_time()
        # 图片
        images = []
