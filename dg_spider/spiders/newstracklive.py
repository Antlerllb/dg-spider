...
class newstracklive(BaseSpider):
    ...
    def parse_3(self, response):
        ...
        try:
            ...
            item['pub_time'] = time_font(new_soup.select('div.text-danger.sub-info-bordered div.time')[0].text) if len(new_soup.select('div.text-danger.sub-info-bordered div.time')) else OldDateUtil.format_time()
            item['body'] = ''
