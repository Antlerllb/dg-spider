...
class ekongoidSpider(BaseSpider):
    ...
    def get_next_page(self, response):
            ...
            if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(temp_time)) >= int(OldDateUtil.time):
    ...
    def get_news_detail(self,response):
        ...
        pub_time = OldDateUtil.format_time2(last_time[1] + ' ' + last_time[0] + ' ' + last_time[2] + ' ' + last_time[3])
