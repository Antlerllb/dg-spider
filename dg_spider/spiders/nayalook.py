...
def nayalook_time_switch1(time_string):
    # 30/11/2020
    # 返回时间戳
    return OldDateUtil.format_time3(str(datetime.strptime(time_string, "%d/%m/%Y")))


def nayalook_time_switch1_2(time_string):
    # 3 days ago
    # 返回时间戳
    return OldDateUtil.format_time3(str(OldDateUtil.format_time2(time_string)))


def nayalook_time_switch2(time_string):
    # 返回%Y-%m-%d %H:%M:%S
    # 3 days ago
    return OldDateUtil.format_time2(time_string)
