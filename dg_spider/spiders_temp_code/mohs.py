...
class MohsSpider(BaseSpider):
    ...
    def parse_page(self,response):
        ...
        try:
            ...
            last_time = f"20{time[2]}-{str(OldDateUtil.EN_1866_DATE[time[1]]).zfill(2)}-{time[0]} 00:00:00"
                ...
                for i in articles:
                    ...
                    try:
                        ...
                        if 'AM' in t:
                            ...
                            pub_time = f"20{time[2]}-{str(OldDateUtil.EN_1866_DATE[time[1]]).zfill(2)}-{time[0]} 00:00:00"
                    except:
                        time = i.select_one('.column-date').text.split()
                        pub_time = f"20{time[2]}-{str(OldDateUtil.EN_1866_DATE[time[1]]).zfill(2)}-{time[0]} 00:00:00"
