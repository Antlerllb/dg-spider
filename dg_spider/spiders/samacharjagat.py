...
class samacharjagatSpider(BaseSpider):
    ...
    def get_next_page(self, response):
            ...
            if OldDateUtil.time == None or format_time3(format_time2(soup.select("body > div > div > div > div > div > div.col-md-8 > div > div > div.col-md-9 > div.cat_page > div")[-1].text.strip())) >= int(OldDateUtil.time):
