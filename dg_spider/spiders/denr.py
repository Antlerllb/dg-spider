...
class denrspider(BaseSpider):
    ...
    def parse_news_page(self,response):
        ...
        for i in data:
            ...
            response.meta['pub_time'] = t[2] + '-' + str(OldDateUtil.month[t[0]]).rjust(2, '0') + '-' + t[1] + " 00:00:00"
            ...
            if OldDateUtil.time is None or int(OldDateUtil.time) < OldDateUtil.str_datetime_to_timestamp(last_time_):
