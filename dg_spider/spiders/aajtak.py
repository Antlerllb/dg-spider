...
class AajtSpider(BaseSpider):
    ...
    def parse_essay(self, response):
        ...
        for i in soup.select('.widget-listing '):  # 静态文章列表
            ...
            response.meta['pub_time'] = OldDateUtil.format_time2(ss)
            if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(ss)) >= int(OldDateUtil.time):
