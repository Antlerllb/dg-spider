...
class RemateSpider(BaseSpider):
    ...
    def parse_page(self,response):
        ...
        if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(soup.select('article .meta-date')[-1].text)) >= int(OldDateUtil.time):
    ...
    def parse_news(self,response):
        ...
        item["pub_time"] = OldDateUtil.format_time2(soup.select('article .meta-date')[0].text)
