...
class KarenSpider(BaseSpider):
    ...
    def parse_page(self, response):
        ...
        try:
            ...
            last_pub_time = OldDateUtil.format_time3(lpt)
        except:
            last_pub_time = OldDateUtil.format_time3(OldDateUtil.format_time())
        if OldDateUtil.time is None or last_pub_time >= int(OldDateUtil.time):
