    ...
    def parse_essay(self, response):
        ...
        for i in soup.find_all(class_='amp-wp-content amp-loop-list'):
            ...
            try:
                ...
                pub_time = OldDateUtil.format_time(0)
            if OldDateUtil.time is None or OldDateUtil.format_time3(OldDateUtil.format_time2(pub_time)) >= int(OldDateUtil.time):  # 未截止，True
