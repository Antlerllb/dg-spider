...
class sandhyapravaktaSpider(BaseSpider):
    ...
    def get_next_page(self, response):
        ...
        if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(content_div.find_all("time",class_="entry-date updated td-module-date")[-1].text)) >= int(OldDateUtil.time):
