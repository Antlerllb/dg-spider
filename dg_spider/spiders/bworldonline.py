...
class bworldonlineSpider(BaseSpider):
    ...
    def parse_time(self, response):
        ...
        if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(html.select('.td-post-date > time')[0].text)) >= int(OldDateUtil.time):
    ...
    def parse_item(self, response):
        ...
        item['pub_time'] = OldDateUtil.format_time2(html.select('.td-post-date > time')[0].text)
