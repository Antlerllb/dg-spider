...
class pravakta(BaseSpider):
    ...
    def get_next_page(self, response):
            ...
            if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(soup.find_all("article")[-1].find("span", class_="item-metadata posts-date").text.strip())) >= int(OldDateUtil.time):
    ...
    def get_news_detail(self,response):
        ...
        pub_time = OldDateUtil.format_time2(soup.find("span", class_="item-metadata posts-date").text.strip())
