...
class agnibanSpider(BaseSpider):
    ...
    def get_next_page(self, response):
            ...
            if OldDateUtil.time == None or OldDateUtil.format_time3(OldDateUtil.format_time2(div.find_all("span",class_="item-metadata posts-date")[-1].text.strip())) >= int(OldDateUtil.time):
